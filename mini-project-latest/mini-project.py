...
class simpleapp(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        self.label3 = Tkinter.Label(frame,textvariable=self.labelvariable3,fg="white",justify="left")
        self.label3.grid(column=0,row=0,sticky='W', pady=(20,0))
        self.labelvariable3.set("URL to analyse :")
        self.textinput = Tkinter.Entry(frame,width=60)
    ...
    def OnButtonClick(self):
        ...
        if url_input != "":
            ...
            eval_label="Number of eval functions: " + str(eval_count) + "\n"
            self.label7.configure(bg='black', fg='white')
